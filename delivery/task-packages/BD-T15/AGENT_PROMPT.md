你正在执行北斗仓库 `yhwhhwhy001/beidou` 的任务 `BD-T15 — CI 与证据系统加固`。
...
3. `delivery/task-packages/BD-T15/TASK.md`
4. `delivery/task-packages/BD-T15/ACCEPTANCE.yaml`
5. `delivery/task-packages/BD-T15/ROLLBACK.md`
