你正在执行北斗仓库 `yhwhhwhy001/beidou` 的任务 `BD-T02 — 统一配置提供器`。
...
3. `delivery/task-packages/BD-T02/TASK.md`
4. `delivery/task-packages/BD-T02/ACCEPTANCE.yaml`
5. `delivery/task-packages/BD-T02/ROLLBACK.md`
