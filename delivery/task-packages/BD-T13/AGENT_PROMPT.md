你正在执行北斗仓库 `yhwhhwhy001/beidou` 的任务 `BD-T13 — 独立对账与差异门禁`。

基线：`main@6b0d95dfa67465be421d9a4f5eaa5a406e7c3341`。当前项目状态必须保持 PIVOT；Mainnet/真实资金永久禁止。本任务前置依赖：BD-T03, BD-T10, BD-T12。

先读取：
1. `00_EXECUTION_MASTER.md`
2. `01_AGENT_OPERATING_PROTOCOL.md`
3. `delivery/task-packages/BD-T13/TASK.md`
4. `delivery/task-packages/BD-T13/ACCEPTANCE.yaml`
5. `delivery/task-packages/BD-T13/ROLLBACK.md`
