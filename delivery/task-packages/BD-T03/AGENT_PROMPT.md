你正在执行北斗仓库 `yhwhhwhy001/beidou` 的任务 `BD-T03 — 单一 Exchange Gateway`。

基线：`main@6b0d95dfa67465be421d9a4f5eaa5a406e7c3341`。当前项目状态必须保持 PIVOT；Mainnet/真实资金永久禁止。本任务前置依赖：BD-T01, BD-T02。

先读取：
1. `00_EXECUTION_MASTER.md`
2. `01_AGENT_OPERATING_PROTOCOL.md`
3. `delivery/task-packages/BD-T03/TASK.md`
4. `delivery/task-packages/BD-T03/ACCEPTANCE.yaml`
5. `delivery/task-packages/BD-T03/ROLLBACK.md`
