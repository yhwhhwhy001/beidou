...
| --- | --- |
| bars | 49024 |
| gross_return | 20.7827 |
| net_return | 15.2052 |
| annualized_sharpe | 1.7087 |
| annualized_sharpe_gross | 1.8730 |
| max_drawdown | -0.2422 |
| average_absolute_exposure | 0.8540 |
| turnover_units | 395.0 |
| nonzero_target_bars | 49024 |
| hit_rate | 0.5128 |
| cost_share_of_gross | 0.0878 |
| guards | replayed=yes; gross_capped_bars=355; daily_loss_pause_bars=36; bars=49024; min_margin_buffer=99.0929; liquidation_touches=0 |
...
| 1000PEPEUSDT | net=0.189 sharpe=0.81 turnover=10.6 |
...
| ADAUSDT | net=0.060 sharpe=0.27 turnover=17.9 |
...
| BTCUSDT | net=0.376 sharpe=1.35 turnover=26.4 |
...
| DOGEUSDT | net=0.157 sharpe=0.56 turnover=24.9 |
...
| ETHUSDT | net=0.168 sharpe=0.62 turnover=25.6 |
...
| HYPEUSDT | net=0.100 sharpe=0.77 turnover=3.2 |
...
| PUMPUSDT | net=0.019 sharpe=0.25 turnover=1.0 |
...
| SOLUSDT | net=0.214 sharpe=0.76 turnover=22.7 |
...
| SUIUSDT | net=0.151 sharpe=0.79 turnover=10.1 |
...
| TRBUSDT | net=0.065 sharpe=0.73 turnover=1.6 |
| TRUMPUSDT | net=-0.013 sharpe=-0.14 turnover=1.2 |
...
| XRPUSDT | net=0.100 sharpe=0.36 turnover=26.7 |
...
| ZECUSDT | net=0.044 sharpe=0.38 turnover=2.2 |
