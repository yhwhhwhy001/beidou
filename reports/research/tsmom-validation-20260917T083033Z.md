...
| candidate_sharpe_annual | 1.6621 |
| expected_max_sharpe_annual | 1.6117 |
| dsr | 0.5477 |
| dsr_p_value | 0.4523 |
| pbo | 0.2016 |
| pbo_combinations | 5000 |
| degradation_slope | -0.9899 |
| prob_oos_loss | 0.0000 |
| noise_null | sharpe_variance_period=0.0000; expected_max_sharpe_annual=1.2156; dsr_p_value=0.1444 |
| ledger_trials | 139 |
...
| variance | 0.0000 |
| threshold_annual | 1.5701 |
| expected_max_annual | 1.2684 |
| p_family | 0.0457 |
| oos_sharpe_annual | 1.5806 |
| caliber | ENFORCED at N=293 (the per-strategy bucket): threshold 1.57, margin +0.01.  REPORTED and never enforced at N=1803 (the whole library): threshold 1.77, margin -0.19, p_family 0.2502.  Which N is the gate is R0 / KILL-AR-01, an operator ruling rather than a property of the arithmetic, and both numbers are printed so the ruling stays arguable from the artefact alone. |
...
| gate | max_sharpe_quantile |
| variance | 0.0000 |
| threshold_annual | 1.7678 |
| expected_max_annual | 1.5016 |
| p_family | 0.2502 |
| oos_sharpe_annual | 1.5806 |
...
| key | value |
| --- | --- |
| time_split_sharpes | 1.3781, 1.4600, 1.6271, 1.8723 |
