...
| key | value |
| --- | --- |
| x1 | oos=1.59 threshold=1.55 margin=0.04 clears=1.00 |
| x1.5 | oos=1.53 threshold=1.55 margin=-0.02 clears=0.00 |
| x2 | oos=1.47 threshold=1.55 margin=-0.08 clears=0.00 |
