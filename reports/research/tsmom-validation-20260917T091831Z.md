...
| expected_max_sharpe_annual | 1.4852 |
| dsr | 0.6627 |
| dsr_p_value | 0.3373 |
| pbo | n/a |
...
| prob_oos_loss | n/a |
| noise_null | sharpe_variance_period=0.0000; expected_max_sharpe_annual=1.0739; dsr_p_value=0.0812 |
| ledger_trials | 105 |
...
| variance | 0.0000 |
| threshold_annual | 1.4493 |
| expected_max_annual | 1.1204 |
| p_family | 0.0168 |
...
| key | value |
| --- | --- |
| x1 | oos=1.58 threshold=1.45 margin=0.13 clears=1.00 |
| x1.5 | oos=1.52 threshold=1.45 margin=0.07 clears=1.00 |
| x2 | oos=1.46 threshold=1.45 margin=0.01 clears=1.00 |
...
- single configuration: sharpe=1.66
