...
| annualized_sharpe_gross | 1.7921 |
| max_drawdown | -0.4029 |
...
| guards | replayed=yes; gross_capped_bars=4070; daily_loss_pause_bars=491; bars=49247; min_margin_buffer=97.1690; liquidation_touches=0 |
...
| candidate_sharpe_annual | 1.6670 |
| expected_max_sharpe_annual | 1.5018 |
| dsr | 0.6525 |
| dsr_p_value | 0.3475 |
| pbo | 0.2166 |
| pbo_combinations | 5000 |
| degradation_slope | -0.9931 |
| prob_oos_loss | 0.0000 |
| noise_null | sharpe_variance_period=0.0000; expected_max_sharpe_annual=1.0787; dsr_p_value=0.0813 |
| ledger_trials | 107 |
...
| variance | 0.0000 |
| threshold_annual | 1.4538 |
| expected_max_annual | 1.1255 |
| p_family | 0.0167 |
| oos_sharpe_annual | 1.5859 |

## Cost stress against that gate (same folds, same N, best_key basis)

| key | value |
| --- | --- |
| x1 | oos=1.59 threshold=1.45 margin=0.13 clears=1.00 |
| x1.5 | oos=1.53 threshold=1.45 margin=0.07 clears=1.00 |
| x2 | oos=1.47 threshold=1.45 margin=0.01 clears=1.00 |

## Stability

| key | value |
| --- | --- |
| time_split_sharpes | 1.3266, 1.4465, 1.7019, 1.8826 |
| worst_neighbour_degradation | 0.0683 |
| parameter_neighbourhood | entry_threshold=down=1.56 base=1.67 up=1.55; return_scale=down=1.63 base=1.67 up=1.67; vol_window=down=1.67 base=1.67 up=1.67 |
