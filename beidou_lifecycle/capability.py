...
class CapabilityRegistry:
    ...
    def negotiate(
        self, module: str, consumer_version: CapabilityVersion
        ...
        for provider in reversed(sorted(providers, key=lambda v: v.schema_version)):
            ...
            if (provider.schema_version >= consumer_version.schema_version and
                    provider.min_compatible_version <= consumer_version.schema_version):
                return CapabilityNegotiation(
                    consumer_version=consumer_version,
                    provider_version=provider,
